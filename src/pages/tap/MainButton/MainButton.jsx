...
const MainButton = forwardRef((_, ref) => {
  ...
  return (
    <div className={styles.container}>
      <svg
        ...
        {/* Frame 2 */}
        <g ref={frame2Ref}>
          <g filter="url(#filter0_d_5045_42301)">
            <path
          ...
          <g filter="url(#filter1_d_5045_42301)">
            <path
              d="M189.5 83.4641C193.213 81.3205 197.787 81.3205 201.5 83.4641L310.311 146.286C314.023 148.429 316.311 152.391 316.311 156.678V282.322C316.311 286.609 314.023 290.571 310.311 292.714L201.5 355.536C197.787 357.68 193.213 357.68 189.5 355.536L80.6895 292.714C76.9766 290.571 74.6895 286.609 74.6895 282.322V156.678C74.6895 152.391 76.9766 148.429 80.6895 146.286L189.5 83.4641Z"
              fill="#161C30"
            />
        ...
        <g ref={frame1Ref}>
          ...
          <g filter="url(#filter2_d_5045_42301)">
            <path
        ...
        {/* Icon */}
        {/* <g ref={iconRef} filter="url(#filter3_d_5045_42301)">
          <rect
            x="165.5"
            y="184"
            width="59"
          ...
          />
          <path
            d="M234.533 248.303C234.562 249.744 232.965 250.674 231.76 249.882L216.452 239.826C215.864 239.44 215.106 239.429 214.507 239.798L197.745 250.117C197.175 250.467 196.459 250.476 195.881 250.139L178.095 239.758C177.502 239.412 176.765 239.43 176.19 239.806L160.751 249.894C159.545 250.682 157.952 249.752 157.981 248.313C159.785 158.566 232.724 158.562 234.533 248.303Z"
            fill="url(#paint2_linear_5045_42301)"
          />
          <path
            d="M234.283 248.308C234.308 249.56 232.924 250.348 231.897 249.673L216.59 239.617C215.921 239.178 215.058 239.165 214.376 239.585L197.614 249.904C197.123 250.206 196.505 250.213 196.007 249.923L178.221 239.542C177.546 239.148 176.707 239.169 176.053 239.597L160.614 249.685C159.586 250.356 158.206 249.568 158.231 248.318C158.681 225.912 163.571 209.133 170.66 197.963C177.748 186.795 187.021 181.251 196.255 181.25C205.489 181.249 214.762 186.791 221.851 197.958C228.94 209.126 233.831 225.903 234.283 248.308Z"
            stroke="url(#paint3_linear_5045_42301)"
            strokeWidth="0.5"
          />
        </g> */}

        {/* Frame 3 */}
        <g ref={frame3Ref} opacity="0.6" filter="url(#filter4_d_5045_42301)">
          <path
        ...
        {/* Frame 4 */}
        <g ref={frame4Ref} opacity="0.2" filter="url(#filter5_d_5045_42301)">
          <path
        ...
        {/* Frame 5 */}
        <g ref={frame5Ref} opacity="0.1" filter="url(#filter6_d_5045_42301)">
          <path
        ...
        <defs>
          ...
          <linearGradient
            id="paint3_linear_5045_42301"
            x1="196.257"
            y1="181"
            x2="196.257"
            y2="251.726"
            gradientUnits="userSpaceOnUse">
            <stop stopColor="#D6F8FF" />
            <stop offset="1" stopColor="#71CCFF" />
          </linearGradient>
        </defs>
      </svg>
